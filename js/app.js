class TimerManager {
    ...
    createCharts() {
        ...
        // Gráfico de Barras para comparação entre Hora do Roteiro e somatório das Categorias N e A
        this.classBarChart = new Chart(ctxBar, {
            type: 'bar',
            data: {
                labels: ['Hora do Roteiro', 'Total Categorias N + A'],
                datasets: [{
                    label: 'Tempo em Segundos',
                    data: [0, 0], // Hora do roteiro, somatório das categorias N e A
    ...
    updateBarChart() {
        // Capturando o valor da Hora do Roteiro em segundos
        const horaRoteiro = document.getElementById('hh').value ? parseInt(document.getElementById('hh').value) * 3600 : 0;
        // Somando o tempo total das categorias N e A
        const totalN = this.calculateTotalTime('N');
        const totalA = this.calculateTotalTime('A');
        const totalNA = totalN + totalA;
    
        this.classBarChart.data.datasets[0].data = [horaRoteiro, totalNA];
    ...
    addTimer() {
        ...
        // Limpar o campo de entrada e restaurar a seleção de categoria
        document.getElementById('timerName').value = '';
        document.getElementById('timerCategory').selectedIndex = 0;
